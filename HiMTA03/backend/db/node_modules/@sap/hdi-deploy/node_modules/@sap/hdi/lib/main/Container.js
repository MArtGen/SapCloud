...
class Container extends HDIBase {
   ...
   * @param {Parameter[]} params parameters controlling the current procedure call
   * @param {LibraryInformationResultTupleCB} cb - The callback handling the result.
   * @returns {undefined} Returns nothing/undefined.
   * @async
   */
  listConfiguredLibraries(params, cb) {
    ...
    this.fillHelperTable(CONSTANTS.PARAMETERS_TABLE, params)
      .then(() => this.executeCall(sql, result))
      .then((res) => cb(null, res))
      .catch((e) => cb(e));
  }
   ...
   * @param {Parameter[]} params parameters controlling the current procedure call
   * @param {StatusResultTupleCB} cb - The callback handling the result.
   * @returns {undefined} Returns nothing/undefined.
   * @async
   */
   ...
   * @param {MetadataContentResultTupleCB} cb - The callback handling the result.
   * @returns {undefined} Returns nothing/undefined.
   * @async
   */
   ...
   *               - IGNORE_FILES: true, false (default)
   *               - IGNORE_FOLDERS: true, false (default)
   * @param {MetadataResultTupleCB} cb - The callback handling the result.
   * @returns {undefined} Returns nothing/undefined.
   * @async
   */
   ...
   * @param {PathParameter[]} pathParameters parameters controlling the current procedure call, specific for each single file
   * @param {Parameter[]} params parameters controlling the current procedure call
   * @param {MakeGroupResultTupleCB} cb - The callback handling the result.
   * @returns {undefined} Returns nothing/undefined.
   * @async
   */
   ...
   * @param {Parameter[]} params parameters controlling the current procedure call
   * @param {DependencyTupleCB} cb - The callback handling the result.
   * @returns {undefined} Returns nothing/undefined.
   * @async
   */
