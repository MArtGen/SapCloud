...
class AddDbHandler extends AddHandler {
    ...
    async _extendGlobalPackageJsonHana(packageJson, options) {
        ...
        const newDependencies = await NpmDependenciesHelper.updateDependencies(packageJson.dependencies, options);
    ...
    async _extendGlobalPackageJsonSqlite(packageJson, options) {
        ...
        const newDevDependencies = await NpmDependenciesHelper.updateDependencies(packageJson.devDependencies, options);
