...
class MTAHelper {
    ...
    static async update(moduleFolder, mtaPath, moduleType, options) {
        ...
        switch (moduleType) {
            ...
            case Constants.MODULE_TYPE_SRV: {
                this._addSrvModule(moduleFolder, mta, options.projectName, options.srvTechnology, options.srvMemory, options);
                fileChanged = true;
                break;
            }
    ...
    static _addSrvModule(folderName, mta, projectName, srvTechnology, srvMemory, options) { //NOSONAR
